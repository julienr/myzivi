...
DATABASES = {
    'default': {
        ...
        'NAME': 'zividb',                      # Or path to database file if using sqlite3.
...
# Foreign key traversal in serialization
...
SECRET_KEY = 'lgp+d7_jemf*h0nsn#f5-s5u(pe_kq_f9wh^iytxw@x0kn1+dv'
...
ROOT_URLCONF = 'ziviweb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ziviweb.wsgi.application'
